...
if [ "$ARCH" == "x86_64" ]; then
    wget "https://www.downloadeasy.ir/Github/Zip_Files/Linux_AMD64/${PROMETHEUS_FILE_AMD64}"
    tar xzf "$PROMETHEUS_FILE_AMD64"
    PROMETHEUS_DIR="prometheus-${PROMETHEUS_VERSION_AMD64}.linux-amd64"
elif [ "$ARCH" == "aarch64" ]; then
    wget "https://www.downloadeasy.ir/Github/Zip_Files/Linux_ARM64/${PROMETHEUS_FILE_ARM64}"
...
if [ "$ARCH" == "x86_64" ]; then
    wget "https://www.downloadeasy.ir/Github/Zip_Files/Linux_AMD64/${NODE_EXPORTER_FILE_AMD64}"
    tar xzf "$NODE_EXPORTER_FILE_AMD64"
    NODE_EXPORTER_DIR="node_exporter-${NODE_EXPORTER_VERSION}.linux-amd64"
elif [ "$ARCH" == "aarch64" ]; then
    wget "https://www.downloadeasy.ir/Github/Zip_Files/Linux_ARM64/${NODE_EXPORTER_FILE_ARM64}"
...
if [ "$ARCH" == "x86_64" ]; then
    wget "https://www.downloadeasy.ir/Github/Zip_Files/Linux_AMD64/${GRAFANA_FILE_AMD64}"
    sudo dpkg -i "$GRAFANA_FILE_AMD64"
elif [ "$ARCH" == "aarch64" ]; then
    wget "https://www.downloadeasy.ir/Github/Zip_Files/Linux_ARM64/${GRAFANA_FILE_ARM64}"
