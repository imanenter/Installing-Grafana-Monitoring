...
wget https://www.downloadeasy.ir/Github/Zip_Files/prometheus-2.49.1.linux-amd64.tar.gz
...
wget https://www.downloadeasy.ir/Github/Zip_Files/node_exporter-1.7.0.linux-amd64.tar.gz
...
if [ "$system_architecture" != "amd64" ] && [ "$system_architecture" != "arm64" ]; then
    print_error "Unsupported system architecture: $system_architecture"
    exit 1
fi

# Install Grafana based on system architecture
if [ "$system_architecture" == "amd64" ]; then
    # Ubuntu and Debian (AMD64 Bit)
    grafana_url="https://www.downloadeasy.ir/Github/Zip_Files/grafana-enterprise_10.3.1_amd64.deb"
elif [ "$system_architecture" == "arm64" ]; then
    # Ubuntu and Debian (ARM64)
    grafana_url="https://www.downloadeasy.ir/Github/Zip_Files/grafana-enterprise_10.3.1_arm64.deb"
fi

# Install Grafana
sudo apt-get install -y adduser libfontconfig1 musl
wget "$grafana_url"
sudo dpkg -i $(basename "$grafana_url")
